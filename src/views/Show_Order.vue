...
export default {
  ...
  setup() {
    ...
    const fetchOrders = async () => {
      ...
      error.value = null;
      try {
        const res = await fetch("http://localhost:8081/finalproject/php_api/show_orders.php");
    ...
    const updateStatus = async (order) => {
      try {
        const res = await fetch("http://localhost:8081/finalproject/php_api/update_order_status.php", {
          method: "POST",
    ...
    const deleteOrder = async (order) => {
      ...
      try {
        const res = await fetch("http://localhost:8081/finalproject/php_api/delete_order.php", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
    ...
    const deleteAllCancelledOrders = async () => {
      ...
      try {
        const res = await fetch("http://localhost:8081/finalproject/php_api/delete_cancelled_orders.php", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
        });
        const data = await res.json();
